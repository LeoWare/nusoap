 ...
 * @access   public
 */
class nusoap_server extends NuSoap\nusoap_base
{
    /**
    ...
    function serialize_return()
    {
        ...
        // if fault
        if (isset($this->methodreturn) && is_object($this->methodreturn) && ((get_class($this->methodreturn) == 'NuSoap\soap_fault') || (get_class($this->methodreturn) == 'NuSoap\nusoap_fault'))) {
