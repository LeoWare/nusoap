...
/**
 * Parses an XML Schema, allows access to its data, other utility methods.
 *
 * Imperfect and no validation... yet, but quite functional.
 *
 ...
 * @access   public
 */
class XMLSchema extends NuSoap\Base
{
    // files
    var $schema = '';
    var $xml = '';
